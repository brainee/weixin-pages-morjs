...
Page({
  ...
  searchArea() {
    searchAreaService({
      "head":
        { "uid": "", "token": "", "requestTime": "2024-04-07T02:18:21.282Z", "appId": "", "clientType": "1", "clientVersion": "", "moduleCode": "common", "chartTableCode": null },
      "type": 1
    }).then(data => {
      if (data?.length > 0) {
  ...
  findAirlines() {
    findAirlinesService({
      "head":
        { "uid": "", "token": "", "requestTime": "2024-04-07T02:18:25.687Z", "appId": "", "clientType": "1", "clientVersion": "", "moduleCode": "common", "chartTableCode": null },
      "type": 1
    }).then(data => {
      if (data?.length > 0) {
