...
export const envVersion = versionInfo?.miniProgram?.envVersion||"release";

export const domain = config.domainList[envVersion];
console.log("[zy]config",envVersion, 'domain',domain);
