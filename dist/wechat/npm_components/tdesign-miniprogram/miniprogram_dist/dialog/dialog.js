"use strict";
(wx["mor_modules"] = wx["mor_modules"] || []).push([["npm_components/tdesign-miniprogram/miniprogram_dist/dialog/dialog"],{

/***/ "../node_modules/tdesign-miniprogram/miniprogram_dist/dialog/dialog.js":
/*!*****************************************************************************!*\
  !*** ../node_modules/tdesign-miniprogram/miniprogram_dist/dialog/dialog.js ***!
  \*****************************************************************************/
...
/* harmony import */ var _props__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./props */ "../node_modules/tdesign-miniprogram/miniprogram_dist/dialog/props.js");
...
let Dialog = class Dialog extends _common_src_index__WEBPACK_IMPORTED_MODULE_0__.SuperComponent {
    constructor() {
        super(...arguments);
        this.options = {
            multipleSlots: true,
        ...
        this.observers = {
            'confirmBtn, cancelBtn'(confirm, cancel) {
                ...
                const useBaseVariant = [confirm, cancel].some((item) => (0,_common_utils__WEBPACK_IMPORTED_MODULE_3__.isObject)(item) && item.variant && item.variant !== 'text');
        ...
        this.methods = {
            onTplButtonTap(e) {
                ...
                if (!hasOpenType && ['confirm', 'cancel'].includes(type)) {
                    (_a = this[(0,_common_utils__WEBPACK_IMPORTED_MODULE_3__.toCamel)(`on-${type}`)]) === null || _a === void 0 ? void 0 : _a.call(this, type);
                }
                if (evtType !== 'tap') {
...
/******/ __webpack_require__.O(0, ["mor.v"], function() { return __webpack_exec__("../node_modules/tdesign-miniprogram/miniprogram_dist/dialog/dialog.js"); });
