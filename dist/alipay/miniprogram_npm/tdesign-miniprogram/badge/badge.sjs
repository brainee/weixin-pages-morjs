...
export { getBadgeValue };
export { getBadgeStyles };
export { getBadgeOuterClass };
export { getBadgeInnerClass };
export { isShowBadge };
export default { getBadgeValue, getBadgeStyles, getBadgeOuterClass, getBadgeInnerClass, isShowBadge };
