"use strict";
(my["mor_modules"] = my["mor_modules"] || []).push([["pages/usercenter/register/pass/index"],{
...
__MOR_PAGE__({
    ...
    setPass: function (res) {
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function* () {
            ...
            let { password, password2 } = this.data.formData;
            const App = getApp();
            ...
            (0,_services_usercenter_registerService__WEBPACK_IMPORTED_MODULE_0__.registerService)({
                ...
                if (data) {
                    __MOR_API__.navigateTo({ url: `/pages/usercenter/register/mail/index?account=${account}&operate=${operate}` });
                }
            });
        });
    },
